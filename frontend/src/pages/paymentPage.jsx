...
const PaymentPage = () => {
  ...
  const handlePayment = async () => {
    ...
    try {
      // Send the simulated payment data to the backend
      await api.post('/applications/confirm-payment', {
        paymentId: simulatedPaymentId,
        paymentAmount: feesAmount
      });
      // On success, move to the final application print page
  ...
  return (
    // Removed container as ProtectedRoute/Layout handles it
      ...
      <div className="bg-white p-6 md:p-8 rounded-lg shadow-lg border border-gray-200 max-w-2xl mx-auto"> 
        ...
        <div className="space-y-3 text-sm md:text-base">
          ...
          {/* REMOVED FATHER'S NAME: 
            This field is no longer in the Redux 'student' object.
            It's now part of the application data, which we don't need to re-fetch here.
          */}
          <div className="flex justify-between items-center border-b border-gray-200 py-2">
